...
class other_website:
    ...
    def __init__(self):
        ...
        """ Initializes the names url and soup
        
        Args:
            self, a parameter that individually initializes an object 
        """
    ...
    def print_course(self, courses):
        ...
        Args:
            self: a parameter that individually initializes an object
            courses: the courses extracted from the extract_courses method
    ...
    def calculate_cost(self):
        ...
        Side Effects:
            print(): Prints out a prompt asking the expected cost of tuition. If cost is 0, a print of "This Course is FREE!" is printed, if not, the cost is printed
    ...
    def scrape(self):
        ...
        """ A function that calls the methods to be executed
